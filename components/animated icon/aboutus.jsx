      ...
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          <motion.div
            ...
            <h3 className="text-2xl font-bold" style={{color: '#111', background: '#fff'}}>
              {testimonials[active].name ? testimonials[active].name : <span style={{ color: 'red' }}>No Name Present</span>}
            </h3>
