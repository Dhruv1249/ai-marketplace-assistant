...
/* =========================
   Enhanced Editable Element with more element types
   ========================= */
function EnhancedEditableElement({
  ...
  style = {},
  elementId,
  type = "text", // text, button, link, image, shape
  selectedElement,
  setSelectedElement,
  currentText,
  currentStyle = {},
  currentProps = {}, // For button links, image src, etc.
}) {
  ...
  return (
    ...
    >
      ...
      {isSelected && isEditing && (
        <button
          className="absolute -top-3 -right-3 w-6 h-6 bg-red-500 text-white rounded-full text-xs hover:bg-red-600 z-30"
